...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      select("watermark_enabled", "Watermark", "false", [["false","Off"],["true","On"]]),
      {key:"watermark_text",label:"Watermark text",type:"text",value:""},
  ...
  {
    id:"cut", title:"Cut Video", category:"Export", kind:["video"], accent:"green", description:"Yalnızca seçilen zaman aralığını dışa aktarır.", detail:"Hızlı mod görüntü ve sesi yeniden kodlamadan birebir kopyalar; anında tamamlanır ve dosya boyutunu şişirmez. Kare hassas mod yalnız özellikle seçildiğinde yeniden kodlar.",
...
const enText: Record<string, [string, string]> = {
  ...
  encode:["Re-encodes with the selected CPU or GPU encoder.","Only encoders verified on this PC are listed."],
