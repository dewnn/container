...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    fields: [number("fps", "FPS", 12, 1, 120, 1), number("video_badness", "Video badness", 5, 1, 20, 1), number("audio_badness", "Audio badness", 5, 1, 20, 1), number("shrink", "Scale divisor", 4, 1, 20, 1)],
  },
  {
